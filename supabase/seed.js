...
// Make sure to have NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY in your .env.local
...
async function seed() {
  console.log('🚀 Starting Supabase quiz seeding...');
  ...
  for (const examData of EXAMS) {
    ...
    try {
      ...
      console.log(`✅ Created Exam: ${exam.title} (${insertedExam.id})`);
      ...
      console.error(`❌ Error seeding exam ${exam.title}:`, error);
    }
  }

  console.log('🎉 Supabase quiz seeding complete!');
}
